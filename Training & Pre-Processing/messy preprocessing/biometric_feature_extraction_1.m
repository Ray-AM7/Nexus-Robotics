...
%% Segmentation and Processing (Non-Overlapping Windows)
count = 0;
...
disp('Saving: First participant, first gesture, non-overlapping biometric data')
save(['Feature Extracted BM' filesep 'FirstGesture_FirstParticipant.mat'], 'FeatSet', '-v7.3')
